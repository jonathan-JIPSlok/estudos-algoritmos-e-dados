// Trabalhando com arvore AVL (criando, manipulando, buscando)
...
impl Node {
    ...
    fn update_height(&mut self) {
        //cmp::max - vai calcular o valor máximo de todo o node
        self.height = cmp::max(Node::height(&self.left), Node:: height(&self.right))
    }
    ...
    fn rotate_right(&mut self) -> Box<Node> {
        ...
        self.update_height();
        left_child.right = Some(Box::new(self.clone()));  // Clona o nó para não mover o nó original
    ...
    fn rotate_left(&mut self) -> Box<Node> {
        ...
        self.update_height();
        right_child.left = Some(Box::new(self.clone())); // Clona o nó para não mover o nó original
    ...
    fn insert(mut self, value: i32) -> Box<Node> {
        ...
        // Para Avl, balance a árvore após a inserção
        self.balance()
    }
